...
public class menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BIENVENU AU JEU ROMZI STAR");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            Partie partie = new Partie(8, 8, 18); // Exemple avec une grille 5x5 et 5 bombes
            new FenetrePrincipale(partie).setVisible(true);
        // TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Partie partie = new Partie(10, 10, 40); // Exemple avec une grille 5x5 et 5 bombes
            new FenetrePrincipale(partie).setVisible(true);
